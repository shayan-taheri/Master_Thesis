...
testDir = '/media/SHAYAN_HDD/Results/test_res_2/1';
...
y = m0.recs_norm;
y = y(g_ix); % Using norm of aligned records that are good.
% ---- Linear Regression ----
p = polyfit(x,y,deg);
yfit = polyval(p,x);
...
ylabel('Norm of Aligned Records', 'FontSize', 14);
...
text(max(x)-0.011,min(y)+0.1,['R^2 = ',Rsquare,' , ', 'R^2 Adjusted = ',Rsquare_Adj],'FontSize',12,'FontName','Times New Roman');
% ---- Saving Results ----
