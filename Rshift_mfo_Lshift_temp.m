% *** Right Shifted MFO ~ Left Shifted Temperature ***
...
recsDir1 = ['/media/SHAYAN_HDD/Data/collection_2/',card];
figDir = '/media/SHAYAN_HDD/Results/Analysis_6/Rshift_mfo_Lshift_temp/col2';
