...
% ---- Matched Filter Output (Response) ----
...
% ---- Norm of Aligned Records (Predictor) ----
x = m0.recs_norm;
x = x(g_ix);
...
hold on;
plot(x,yfit,'-r');
xlabel('Norm of Aligned Records', 'FontSize', 14);
...
text(max(x)-1.4,min(y)+60,['R^2 = ',Rsquare,' , ', 'R^2 Adjusted = ',Rsquare_Adj],'FontSize',12,'FontName','Times New Roman');
% ---- Saving Results ----
