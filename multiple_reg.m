...
% --- Fetching Normalized Vector of Aligned Records (Second Predictor) ---
z = m0.recs_norm;
z = z(g_ix);
...
ylabel('Norm of Aligned Signal', 'FontSize', 14);
...
title(['Analysis of ',card,' Card Residual'], 'FontSize', 16);
set(gca, 'fontsize', 12);
% ---- Saving Residual ----
saveas(fig_id,['/media/SHAYAN_HDD/Results/reg_res/',card,'_residual','.pdf']);
% -------------------------------