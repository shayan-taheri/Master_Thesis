% *** Performing Simple Linear Regression for N-Degree Polynomial using MAV Data ***
...
ylabel('Mean of Absolute Value', 'FontSize', 14);
...
hold off;
text(9971.4,1.951,['R^2 = ',num2str(rsq_val)],'FontSize',12,'FontName','Times New Roman');
saveas(fig_id,['/media/SHAYAN_HDD/Results/Collection_2/auto_mav/',card,...
    '_',nomStr,'_',num2str(order_var),'.pdf']);

% ---- Saving All R-Squared Values and Nominal Temperatures ----
dash_line = '----------------------------------------------------------';

fileID = fopen(['/media/SHAYAN_HDD/Results/Collection_2/auto_mav/',card,...
