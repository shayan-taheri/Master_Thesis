...
% MFO ~ Temperature + IC Voltage + Fitted MFO (using Time)
...
saveas(fig_id,[figDir,'/',card,'_resid_dis_ic','.pdf']);
...
saveas(fig_id,[figDir,'/',card,'_tres_dis_ic','.pdf']);
...
saveas(fig_id,[figDir,'/',card,'_fit_dis_ic','.pdf']);
...
saveas(fig_id,[figDir,'/',card,'_ytot_dis_ic','.pdf']);
...
saveas(fig_id,[figDir,'/',card,'_resid_chg_ic','.pdf']);
...
saveas(fig_id,[figDir,'/',card,'_tres_chg_ic','.pdf']);
...
saveas(fig_id,[figDir,'/',card,'_fit_chg_ic','.pdf']);
...
saveas(fig_id,[figDir,'/',card,'_ytot_chg_ic','.pdf']);
% ----------------------------------