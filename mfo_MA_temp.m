% *** Matched Filter Output ~ Moving Average (Temperature) ***
...
figDir = '/media/SHAYAN_HDD/Results/Analysis_6/mfo_MA_temp/col2';
...
y = y(~nan_ind); % Trimming data to be matched to the regressor data.
