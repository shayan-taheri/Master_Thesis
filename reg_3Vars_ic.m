...
% MFO ~ Temperature + IC Voltage + Time Model
...
saveas(fig_id,['/media/SHAYAN_HDD/Results/Analysis_4/col6/',card,'_dis','_ic_1','.pdf']);
...
saveas(fig_id,['/media/SHAYAN_HDD/Results/Analysis_4/col6/',card,'_dis','_ic_2','.pdf']);
...
saveas(fig_id,['/media/SHAYAN_HDD/Results/Analysis_4/col6/',card,'_dis','_ic_3','.pdf']);
...
saveas(fig_id,['/media/SHAYAN_HDD/Results/Analysis_4/col6/',card,'_chg','_ic_1','.pdf']);
...
saveas(fig_id,['/media/SHAYAN_HDD/Results/Analysis_4/col6/',card,'_chg','_ic_2','.pdf']);
...
saveas(fig_id,['/media/SHAYAN_HDD/Results/Analysis_4/col6/',card,'_chg','_ic_3','.pdf']);
% -------------------------------