...
% MFO ~ Temperature + Transformer Voltage + (1 - exp(-Time/Constant))
...
set(gca, 'fontsize', 12);
% ---- Saving Residual ----
saveas(fig_id,['/media/SHAYAN_HDD/Results/Analysis_3/col6/multiple_reg/',card,'_dis','_tran','.pdf']);
...
set(gca, 'fontsize', 12);
% ---- Saving Residual ----
saveas(fig_id,['/media/SHAYAN_HDD/Results/Analysis_3/col6/multiple_reg/',card,'_chg','_tran','.pdf']);
% -------------------------------